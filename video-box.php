...
Plugin Name: Easy Video Widget Box
 ...
 Description: Simple plugin to add video into your widget box. Supports Youtube, Dailymotion, Vimeo and many other sites that provide embed code.. just don't forget to edit the embed code to the size of your widget box
 Version: 1.4
...
class VideoBox extends WP_Widget
{
    function VideoBox()
    {
        $widget_ops = array('classname' => 'VideoBox', 'description' => 'Embed Youtube, Dailymotion, Vimeo' );
